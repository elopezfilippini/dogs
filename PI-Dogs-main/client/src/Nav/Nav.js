...
export default function Nav(props) {
    ...
    return (  <div>   {currentPage.pathname === "/home" ?    <div >   <SearchBar onSearch={props.onSearch} showAll ={props.showAll} /></div>:null}
        ...
        <Link to={'/NewDog'}><button style={{ margin: "0 auto" }} className="buttonContainer button" >Crear</button></Link>
        <hr />
